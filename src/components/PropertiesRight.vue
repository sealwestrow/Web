    ...
    <div class="p-3 break-words">
      ...
      >
        ...
        <span class="mt-3 tags-custom">
          ...
          <span class="rounded">{{ new Date(Date.now() + (3600 * 1000 * 24)) }} Выбрать дату</span>
        </span>
        <span
      ...
      <div class="date-section">
        ...
        >
          {{ days[new Date(selectedTask.date_create).getDay()] }}, {{ new Date(selectedTask.date_create).getDay() }} {{ months[new Date(selectedTask.date_create).getMonth()] }}
        </p>
      </div>
      <div
        ...
        >
          ...
          <div class="file-custom_attach">
            ...
            >
              ...
              />
            </svg><a :href="key.file_name">{{ key.file_name.split('.')[0] }}.{{ key.file_name.split('.')[1] }}</a>
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <div
            v-if="key.uid_creator==key.uid_creator"
            class="chat-main"
          >
            <div
